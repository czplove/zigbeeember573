...
#ifndef XAP2B //SimEE2 doesn't exist for XAP2b, but this code is shared.
#ifdef SIM_EEPROM_TEST
//Undefine the assert when run the unit test for check for SimEE2.
#undef assert
