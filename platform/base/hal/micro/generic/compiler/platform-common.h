...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * Note that the casting below ensures that IAR will not attempt to
   * optimize these calls away and inline the code. This optimization can
   * cause faults when accessing structs allocated on the heap since they
   * are not always word aligned. Versions greater than 6.40 don't seem
   * to have this issue.
   */
  #define MEMSET(d,v,l)  memset((void*)(d),v,l)
  #define MEMCOPY(d,s,l) memcpy((void*)(d),(void*)(s),l)
  #define MEMMOVE(d,s,l) memmove((void*)(d),(void*)(s),l)
  #define MEMPGMCOPY(d,s,l) memcpy((void*)(d),(void*)(s),l)
