...
#include "hal/micro/occupancy.h"
#include "hal/micro/cortexm3/occupancy-pyd1698.h"
...
#warning "OCCUPANCY_PYD1698_SERIN_PORT not defined in board.h, using default values"
#define OCCUPANCY_PYD1698_SERIN_PORT  HAL_GIC_GPIO_PORT_B
#endif

#ifndef OCCUPANCY_PYD1698_SERIN_PIN
#warning "OCCUPANCY_PYD1698_SERIN_PIN not defined in board.h, using default values"
#define OCCUPANCY_PYD1698_SERIN_PIN  3
#endif

#ifndef OCCUPANCY_PYD1698_DLINK_PORT
#warning "OCCUPANCY_PYD1698_DLINK_PORT not defined in board.h, using default values"
#define OCCUPANCY_PYD1698_DLINK_PORT  HAL_GIC_GPIO_PORT_C
#endif

#ifndef OCCUPANCY_PYD1698_DLINK_PIN
#warning "OCCUPANCY_PYD1698_DLINK_PIN not defined in board.h, using default values"
#define OCCUPANCY_PYD1698_DLINK_PIN  HAL_GIC_GPIO_PORT_6
#endif

#ifndef OCCUPANCY_PYD1698_INSTALLATION_JP_PORT
#warning "OCCUPANCY_PYD1698_INSTALLATION_JP_PORT not defined in board.h, using default value"
#define OCCUPANCY_PYD1698_INSTALLATION_JP_PORT HAL_GIC_PORTB
#endif

#ifndef OCCUPANCY_PYD1698_INSTALLATION_JP_PIN
#warning "OCCUPANCY_PYD1698_INSTALLATION_JP_PIN not defined in board.h, using default value"
...
// Pattern used to inform user that an occupancy event has occurred (when in
// installation mode))
static uint16_t occupancyCalibrationBlinkPattern[] = {100, 100};
...
void emberAfPluginOccupancyPyd1698NotifyEventHandler(void)
{
  ...
  if (handleJumperChange(false) == true) {
    // If the jumper is in place, blink the LED to indicate occupancy
    halLedBlinkLedOff(0);
    halLedBlinkPattern(6, 2, occupancyCalibrationBlinkPattern);
