...
#include "hal/micro/illuminance.h"
#include "hal/micro/cortexm3/illuminance-si1141.h"
...
void emberAfPluginIlluminanceSi1141ReadEventHandler(void)
{
  ...
  uint16_t logLux, rawData,logTableScale, adder, divisor, residue, compareStep;
  uint32_t lux, combinedData;
  uint8_t errorCode;
