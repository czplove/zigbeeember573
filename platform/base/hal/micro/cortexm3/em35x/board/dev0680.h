...
uint16_t gpioCfgPowerDown[6] = {                                                  \
                              ...
                              ((GPIOCFG_OUT        <<PB4_CFG_BIT)| /* SC1nRTS */\
                               ...
                               (GPIOCFG_IN_PUD     <<_GPIO_P_CFGH_Px5_SHIFT)|              \
                               (GPIOCFG_IN_PUD     <<_GPIO_P_CFGH_Px6_SHIFT)|              \
                               /* need to use pulldown for sleep */             \
                               (GPIOCFG_IN_PUD     <<_GPIO_P_CFGH_Px7_SHIFT)),             \
                              ((GPIOCFG_IN_PUD     <<_GPIO_P_CFGL_Px0_SHIFT)|              \
                               (GPIOCFG_OUT        <<_GPIO_P_CFGL_Px1_SHIFT)|              \
                               (GPIOCFG_OUT        <<_GPIO_P_CFGL_Px2_SHIFT)|              \
                               (GPIOCFG_IN_PUD     <<_GPIO_P_CFGL_Px3_SHIFT)),             \
                              ((GPIOCFG_IN_PUD     <<_GPIO_P_CFGH_Px4_SHIFT)|              \
...
uint8_t gpioOutPowerDown[3] = {                                               \
                             ...
                             ((0                  <<_GPIO_P_OUT_Px0_SHIFT)|               \
                              ...
                              (GPIOOUT_PULLUP   <<_GPIO_P_OUT_Px3_SHIFT)|  /* SC1nCTS */\
