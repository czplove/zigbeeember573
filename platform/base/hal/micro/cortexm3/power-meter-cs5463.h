...
#define VOLTAGE_SCALE 422 //full range is 250mV, and the voltage is
                          //scaled down by 1690 in HW 
                          //so the scale constant = 1690 * 0.250
#define CURRENT_SCALE 50 //full range is 50mV, and the current 
...
#define PC        (0 << PC_BIT) //phase compensation, 7 bit value
#define IGAIN     (1 << IGAIN_BIT) //to set I scale to 100mVpp
#define EWA       (0 << EWA_BIT) //0 = Normal outputs (default)
...
#define CS5463_CMD_CALIBRATION_CURRENTVOLTAGE AC_GAIN           0xDE
...
#define CS5463_READ_DELAY_OTA_MS 2000
#define CS5463_MEASUREMENT_DELAY_MS 2000

#define CS5463_OVER_HEAT_TIME_LIMIT 50
#define CS5463_OVER_CURRENT_TIME_LIMIT 50
