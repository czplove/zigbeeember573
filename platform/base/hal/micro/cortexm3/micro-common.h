 ...
 * (Because the PCLK might not evenly divide by 1000000 or even 500000, use
 * quad arithmetic, dividing it by 250000.)
 */
#define MAC_TIMER_TICKS(microseconds) \
  ((((uint32_t)(microseconds) * (halPeripheralClockHz() / 250000)) + 47) / 48)
 ...
 * quad arithmetic, dividing it by 250000.)
 */
#define MAC_TIMER_US(ticks) \
  (((((uint32_t)(ticks) * 48000) / (halPeripheralClockHz() / 250000)) + 500) / 1000)
