...
// This is a temporary workaround until proper leuart support is added to UARTDRV, 
// so that Connect can use that instead of LEUARTDRV. 
// Supposed to be changed after Gecko SDK 5.0.0 comes out - Viktor
#if defined(EMBER_STACK_CONNECT) && defined(CORTEXM3_EZR32HG)
  #include "stack/platform/leuartdrv/inc/serial_leuartdrv.h"
#endif
