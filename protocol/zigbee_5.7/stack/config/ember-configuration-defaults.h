...
// TODO: we don't have one stack profile anymore, we might have two networks
// the first one is Zigbee Pro, the second one is RF4CE.
#if (EMBER_STACK_PROFILE == 2) && !defined(EMBER_TEST)
  #if defined(EMBER_BROADCAST_TABLE_SIZE)
    #error "Cannot override broadcast table size unless (EMBER_STACK_PROFILE != 2)"
  #endif
#endif
 ...
 *  processor idling.  The Ember Zigbee Pro and Zigbee RF4CE stacks require 1
 *  task each, an application and associated libraries may use additional tasks,
...
#ifndef EMBER_RF4CE_PAIRING_TABLE_SIZE
/** @brief The maximum number of pairings supported by the stack.
 */
  #define EMBER_RF4CE_PAIRING_TABLE_SIZE    0
#endif

#ifndef EMBER_RF4CE_PAIRING_TABLE_TOKEN_SIZE
/** @brief The maximum number of pairings stored in non-volatile memory.
 */
  #define EMBER_RF4CE_PAIRING_TABLE_TOKEN_SIZE EMBER_RF4CE_PAIRING_TABLE_SIZE
#endif

#ifndef EMBER_RF4CE_PENDING_OUTGOING_PACKET_TABLE_SIZE
/** @brief The maximum number of outgoing RF4CE packets supported by the stack.
 */
  #define EMBER_RF4CE_PENDING_OUTGOING_PACKET_TABLE_SIZE 0
#endif
