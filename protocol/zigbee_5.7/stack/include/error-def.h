...
#else
DEFINE_ERROR(PASS_UNPROCESSED, 0x7A)
#endif //DOXYGEN_SHOULD_SKIP_THIS
/**
 * @brief
 */
...
#else
DEFINE_ERROR(TX_THEN_DROP, 0x7B)
#endif //DOXYGEN_SHOULD_SKIP_THIS
/**
 * @brief
 */
...
#else
DEFINE_ERROR(COUNTER_FAILURE, 0x7D)
#endif //DOXYGEN_SHOULD_SKIP_THIS
/**
 * @brief
 */
...
#else
DEFINE_ERROR(AUTH_FAILURE, 0x7E)
#endif //DOXYGEN_SHOULD_SKIP_THIS
/**
 * @brief
 */
