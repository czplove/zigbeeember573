...
#define EMBER_RF4CE_LIBRARY_ID              0x11
...
// The Zigbee RF4CE library uses the following to indicate additional
// functionality:
//   Bit 0 indicates whether the device supports target capability.
//     A value of 0 means it is a controller only stack,
//     while a value of 1 means it has target capability.
#define EMBER_ZIGBEE_RF4CE_LIBRARY_CONTROLLER_ONLY            0x00
#define EMBER_ZIGBEE_RF4CE_LIBRARY_HAVE_TARGET_CAPABILITY     0x01
