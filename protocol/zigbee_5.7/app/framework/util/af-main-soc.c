...
uint8_t serialPort = APP_SERIAL;
  ...
  PGM EmberLibraryStatus emNcpLibraryStatus = EMBER_LIBRARY_IS_STUB;
#endif
...
void emberEnergyScanResultHandler(uint8_t channel, int8_t rssi)
{
  emberAfPushCallbackNetworkIndex();
