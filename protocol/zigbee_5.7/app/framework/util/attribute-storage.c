...
PGM uint8_t generatedDefaults[]               = GENERATED_DEFAULTS;
#endif // GENERATED_DEFAULTS

#ifdef GENERATED_MIN_MAX_DEFAULTS
PGM EmberAfAttributeMinMaxValue minMaxDefaults[]          = GENERATED_MIN_MAX_DEFAULTS;
...
PGM EmberAfCommandMetadata generatedCommands[] = GENERATED_COMMANDS;
#endif

PGM EmberAfAttributeMetadata generatedAttributes[] = GENERATED_ATTRIBUTES;
PGM EmberAfCluster generatedClusters[]          = GENERATED_CLUSTERS;
PGM EmberAfEndpointType generatedEmberAfEndpointTypes[]   = GENERATED_ENDPOINT_TYPES;
PGM EmAfNetworkType emAfNetworkTypes[] = EM_AF_GENERATED_NETWORK_TYPES;
PGM EmAfZigbeeProNetwork emAfZigbeeProNetworks[] = EM_AF_GENERATED_ZIGBEE_PRO_NETWORKS;

PGM EmberAfManufacturerCodeEntry clusterManufacturerCodes[] = GENERATED_CLUSTER_MANUFACTURER_CODES;
PGM uint16_t clusterManufacturerCodeCount = GENERATED_CLUSTER_MANUFACTURER_CODE_COUNT;
PGM EmberAfManufacturerCodeEntry attributeManufacturerCodes[] = GENERATED_ATTRIBUTE_MANUFACTURER_CODES;
PGM uint16_t attributeManufacturerCodeCount = GENERATED_ATTRIBUTE_MANUFACTURER_CODE_COUNT;
...
#define endpointType(x)          (EmberAfEndpointType*)&(generatedEmberAfEndpointTypes[fixedEmberAfEndpointTypes[x]])
...
static uint8_t findClusterEndpointIndex(uint8_t endpoint, EmberAfClusterId clusterId, uint8_t mask);
                                       ...
                                       EmberStatus status)
{
  if (apsFrame != NULL && message != NULL && msgLen != 0) {
    EmberAfCluster *cluster = emberAfFindCluster(apsFrame->sourceEndpoint,
                                                 apsFrame->clusterId,
                                                 (((message[0]
...
typedef EmberAfStatus (*ExternalReadWriteCallback)(uint8_t, EmberAfClusterId, EmberAfAttributeMetadata *, uint16_t, uint8_t *);
