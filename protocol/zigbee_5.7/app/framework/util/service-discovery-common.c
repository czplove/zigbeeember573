...
static bool processMatchDescriptorResponse(State *state,
...
static bool processSimpleDescriptorResponse(State *state,
                                               const uint8_t *message,
                                               uint16_t length) 
{
  EmberAfServiceDiscoveryResult result;
...
static bool processAddressResponse(State *state,
                                      const uint8_t *message,
                                      uint16_t length)
{
  EmberAfServiceDiscoveryResult result;
...
static bool processActiveEndpointResponse(State* state,
                                             const uint8_t* message,
                                             uint16_t length)
{
  EmberAfServiceDiscoveryResult result;
