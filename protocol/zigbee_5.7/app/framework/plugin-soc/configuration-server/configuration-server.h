...
#ifndef __CONFIGURATION_SERVER_H__
#define __CONFIGURATION_SERVER_H__

/** @brief Return true if the OTA configuration server is locked.  
 *
 * It is desired to lock down some custom clusters (configuration server, 
 * manufacturing library server).  This funciton tells these cluster plugins 
...
/** @brief Return the minimum on time, in microseconds, supported by the 
 *  power supply.  
 *
...
/** @brief Return the maximum on time, in microseconds, supported by the 
 *  power supply.  
 *
 * Different bulb power supplies have requirements for minimum and maximum on
