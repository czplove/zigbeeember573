...
void zclBufferAddLengthAndStringFromArgument(uint8_t argIndex)
{
  ...
  // value of an uint8_t.
  uint16_t maxLength = APP_ZCL_BUFFER_SIZE - (appZclBufferLen + 1);
...
void zclIdentifyOnOffCommand(void)
{
  ...
  emberAfWriteServerAttribute((uint8_t)emberUnsignedCommandArgument(0), // endpoint
...
// This function has been temporarily deprecated.

// ******************************************************
// send <EUI64> <src endpoint> <dst endpoint>
// Sends a ZCL packet over a Zcl Ip interface. It checks for a valid 
// source Endpoint before it sends it over IP.
// ******************************************************

// void emAfCliSendZclIpCommand(void)
// {
//   EmberEUI64 eui64;
//   // emberCopyStringArgument(0,
//   //                         eui64,
//   //                         8,
//   //                         false);
//   emberCopyBigEndianEui64Argument(0,eui64);
//   emberAfCorePrintln("EUI: %x %x %x %x %x %x %x %x",eui64[0],eui64[1],eui64[2],eui64[3],eui64[4],eui64[5],eui64[6],eui64[7]);
//   uint8_t sourceEndpoint = (uint8_t)emberUnsignedCommandArgument(1);
//   uint8_t destEndpoint = (uint8_t)emberUnsignedCommandArgument(2);

//   emAfApsFrameEndpointSetup(sourceEndpoint, destEndpoint);

//   emberAfCliInternetServerSendCallback(&globalApsFrame,
//                                        eui64,
//                                        appZclBuffer,
//                                        appZclBufferLen);
// }
...
//#define CERTIFICATION_TESTING
  ...
  #endif
  #ifdef ZCL_USING_COLOR_CONTROL_CLUSTER_CLIENT
  {"color-control", NULL, (PGM_P)zclColorControlCommands},
  #endif
#if defined(ZCL_USING_DEMAND_RESPONSE_LOAD_CONTROL_CLUSTER_CLIENT) || defined(ZCL_USING_DEMAND_RESPONSE_LOAD_CONTROL_CLUSTER_SERVER)
