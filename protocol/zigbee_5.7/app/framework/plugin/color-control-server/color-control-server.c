...
static EmberAfStatus writeRemainingTime(uint8_t endpoint,
                                        uint16_t remainingTime)
{
  return emberAfWriteServerAttribute(endpoint,
                                     ZCL_COLOR_CONTROL_CLUSTER_ID,
...
static EmberAfStatus writeColorMode(uint8_t endpoint, 
                                     uint8_t colorMode)
{
...
static EmberAfStatus writeHue(uint8_t endpoint, 
                              uint8_t hue)
{
  return emberAfWriteServerAttribute(endpoint,
                                     ZCL_COLOR_CONTROL_CLUSTER_ID,
...
static EmberAfStatus writeSaturation(uint8_t endpoint, 
                                     uint8_t saturation)
{
  return emberAfWriteServerAttribute(endpoint,
                                     ZCL_COLOR_CONTROL_CLUSTER_ID,
...
static EmberAfStatus writeColorX(uint8_t endpoint, 
                                 uint16_t colorX)
{
  return emberAfWriteServerAttribute(endpoint,
                                     ZCL_COLOR_CONTROL_CLUSTER_ID,
...
static EmberAfStatus writeColorY(uint8_t endpoint, 
                                 uint16_t colorY)
{
  return emberAfWriteServerAttribute(endpoint,
                                     ZCL_COLOR_CONTROL_CLUSTER_ID,
...
static EmberAfStatus writeColorTemperature(uint8_t endpoint, 
                                           uint16_t colorTemperature)
{
  return emberAfWriteServerAttribute(endpoint,
                                     ZCL_COLOR_CONTROL_CLUSTER_ID,
